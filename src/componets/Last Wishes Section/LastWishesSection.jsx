...
export default function LastWishesSection() {
  ...
  return (
    ...
    <section id="memory">
      <div className="grid-box">
        <div className="grid-container">
          <div className="small">
            <img
              src={whatsaapShaving}
              className="shaving animated-image"
              alt=""
            />
          </div>
          <div className="small">
          ...
          <div className="small">
            <img
              src={whatsaapHeadset}
              className="chairHeadset animated-image"
              alt=""
            />
          </div>
          <div className="large">
      ...
      <div className="last-wish-container">
        <h1 className="lastWishes-line-1">
          <span className="last-span-12">ONCE AGAIN </span>
          <span className="last-span-13">WISH YOU </span>
          <span className="last-span-3">A MANY</span>
        </h1>
        <h1 className="lastWishes-line-2">
