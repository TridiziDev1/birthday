...
//   const [isBlastTime, setIsBlastTime] = useState(false);
//   useEffect(() => {
//     const countdownDate = new Date("Oct 4, 2024 22:31:00").getTime();
...
import cake from "../../assets/image 2873.png";
import Box from '../Box/Box';
import celebrationAudio from "../../assets/arya.mp3"; // Add your audio file here
...
const CountdownSection = () => {
  ...
  useEffect(() => {
    const countdownDate = new Date("Oct 5, 2024 00:03:00").getTime();
